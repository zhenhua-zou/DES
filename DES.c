...
// what is the variable "work" 's purpose?  zouzhenhua
...
/*#define READ_64BIT_DATA(data, left, right)           \
    left  = ALT_CI_ENDIAN(*((int*)data));  \
    right = ALT_CI_ENDIAN(*((int*)data+1));*/
...
/*#define WRITE_64BIT_DATA(data, left, right) \
      *((int*)data) = ALT_CI_ENDIAN(left); \
      *((int*)data+1) = ALT_CI_ENDIAN(right);*/
